...
<Page ref="page" :class="pageClasses" actionBarHidden="true" backgroundSpanUnderStatusBar="true">
  <GridLayout class='login'>
    ...
    <LoginInitial ref="loginInitial" @unlock="showUnlockContent()" :visible="state === 'initial'"></LoginInitial>
    <LoginUnlock ref="loginUnlock" :visible="state === 'unlock'"></LoginUnlock>
...
import LoginUnlock from './LoginUnlock.vue'
...
export default {
  ...
  methods: {
    showUnlockContent: function() {
      console.log('showUnlockContent')
      this.$refs.logoContainer.nativeView
        ...
        .then(() => {
          console.log('switching from ' + this.state + ' to unlock')
          this.state = 'unlock'
        })
    },
