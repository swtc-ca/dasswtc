            ...
            <v-template>
                <GridLayout>
                    <GridLayout android:visibility="collapsed" columns="*,auto" class="list-modal-item">
                        ...
                        <Label col="1" :text="'ion-ios-arrow-forward' | fonticon"
                            class="ion list-modal-view-check"
                            v-show="item.value === selectedValue"></Label>
                    </GridLayout>
                    <GridLayout ios:visibility="collapsed" columns="auto,*" class="list-modal-item">
                        <Label :text="'ion-ios-arrow-forward' | fonticon"
                            class="ion list-modal-view-icon" verticalAlignment="center"
                            v-show="item.value !== selectedValue"></Label>
                        <Label :text="'ion-ios-arrow-forward' | fonticon"
                            class="ion list-modal-view-icon selected" verticalAlignment="center"
                            v-show="item.value === selectedValue"></Label>
